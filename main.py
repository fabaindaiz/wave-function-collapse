...
def main():
    ...
    options[5].edges = [1, 1, 0, 0]
    options[6].edges = [0, 1, 1, 0]
    options[7].edges = [0, 0, 1, 1]
    options[8].edges = [1, 0, 0, 1]

    # edge condition for center tiles
    options[9].edges = [0, 1, 0, 1]
    options[10].edges = [1, 0, 1, 0]
    options[11].edges = [1, 1, 1, 1]
